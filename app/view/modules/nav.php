...
<nav class="navbar navbar-expand-md fixed-top navbar-dark bg-primary main-nav">
    ...
    <ul class="nav navbar-nav mx-auto">
        <div class="form-inline" style="width: 600px;" id="searchForm">
            <input class="form-control mr-sm-2" style="width: 510px;" type="text"
                placeholder="zoek uitvaartcentrum/plaats" id="searchInput" name="searchInput"
                onkeyup="searchUitvaartcentra(event)">
            <button class=" btn btn-primary my-sm-0" type="submit" id="searchBtn" name="searchBtn">zoeken</button>
        </div>
    </ul>
    <ul class="nav">
        <li class="nav-item">
            <button class="btn btn-primary mr-2" type="submit" id="addBtn" name="addBtn" data-toggle="modal"
                data-target="#addModal">toevoegen</button>
        </li>
        <li class="nav-item">
            <form method="post" action=""><button class="btn btn-primary mr-2" type="submit" id="logoutBtn"
                    name="logoutBtn">uitloggen</button></form>
        </li>
    </ul>
</nav>
            ...
            <form method="post" action="" name="addcentra">
                ...
                <div class="modal-body form-group">
                    ...
                    <div class="custom-control custom-radio" id="bezorgingInput">
                        <input type="radio" id="customRadio1" name="bezorging" class="custom-control-input"
                            name="bezorging">
                        <label class="custom-control-label" for="customRadio1">Ja</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input type="radio" id="customRadio2" name="bezorging" class="custom-control-input"
                            name="bezorging" checked>
                        <label class="custom-control-label" for="customRadio2">Nee</label>
                    </div>
                    <label class="mt-3" for="opmerkingInput">opmerking</label>
                    <textarea type="text" class="form-control" id="opmerkingInput" style="height: 70px;"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" id="addcentraBtn"
                        name="addcentraBtn">toevoegen</button>
                </div>
            </form>
        </div>
    </div>
